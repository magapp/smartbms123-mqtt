...
public:
	...
	const uint8_t getCurrentCell() const;
	const float getCurrentCellVoltage() const;
	const float getCurrentCellTemperature() const;
...
private:
	...
	float cellVoltageBalance_;
        ...
        uint8_t currentCell_;
        float currentCellVoltage_;
        float currentCellTemperature_;
