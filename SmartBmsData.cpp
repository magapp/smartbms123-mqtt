...
SmartBmsData::SmartBmsData()
{
	this->cellCount_ = 0;
	this->currentCell_ = 0;
	this->currentCellVoltage_ = 0;
	this->currentCellTemperature_ = 0;
...
const uint8_t SmartBmsData::getCurrentCell() const
{
	return this->currentCell_;
}

const float SmartBmsData::getCurrentCellVoltage() const
{
	return this->currentCellVoltage_;
}

const float SmartBmsData::getCurrentCellTemperature() const
{
	return this->currentCellTemperature_;
}
...
{
	return this->lowestCellTemperature_;
}
